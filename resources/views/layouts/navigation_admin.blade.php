<ul>
    <li class="nav-item @if(request()->routeIs('creator.dashboard')) active @endif">
        <a href="{{ route('creator.dashboard' , ['slug' => auth()->guard('creators')->user()->slug]) }}">
              <span class="icon">
    ...
    <li class="nav-item @if(request()->routeIs('dashboard.creator.requests')) active @endif">
        <a href="{{ route('dashboard.creator.requests' , ['slug' => auth()->guard('creators')->user()->slug]) }}">
              <span class="icon">
            ...
            <span class="text">{{ __('Requests') }}</span>
        </a>
    </li>
